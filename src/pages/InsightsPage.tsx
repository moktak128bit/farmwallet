...
interface D {
  ...
  funStats: {
    ...
    monthOverMonthGrowth: number | null; // 순자산 월평균 성장률
    daysToSpendIncome: number | null; // 월수입을 며칠만에 쓰는지
...
const AssetTab = React.memo(function AssetTab({ d }: { d: D }) {
...
const FunTab = React.memo(function FunTab({ d }: { d: D }) {
  const fs = d.funStats;
